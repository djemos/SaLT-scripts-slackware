...
sed -i 's/^floppy:.*/\0one/; s/^audio:.*/\0,one/; s/^video:.*/\0,one/; s/^cdrom:.*/\0one/; s/^lp:.*/\0,one/; s/^plugdev:.*/\0one/; s/^polkitd:.*/\0one/; s/^power:.*/\0one/; s/^pulse:.*/\0one/; s/^netdev:.*/\0one/; s/^scanner:.*/\0one/; s/^users:.*/\0one/; s/^fuse:.*/\0one/; s/^wheel:.*/\0,one/;' "$RDIR"/etc/group
